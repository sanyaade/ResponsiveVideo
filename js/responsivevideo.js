/*
	...
	Docs: http://johnpolacek.github.com/ResponsiveVideo/
...
(function($) {
    ...
    $.responsiveVideo = function(options) {
        ...
        function updateSize() {
            for (var i = 0; i<vidObjects.length; i++) {
				$('#vidobject'+i).width(videoContainers[i].width());
        ...
        plugin.embed = function() {
            for (var i = 0; i<arguments.length; i++) {
                var videoID = arguments[i];
                var videoEl = $('#'+videoID);
				
                var poster = videoEl.attr('poster');
                var videoSources = $('source',videoEl);
                
				// get mp4 source
				var videoSource;
                for (var j=0; j < videoSources.length; j++) {
                    var src = videoSources[j].src;
				...
				// get size
				var width = videoEl.attr('width');
                var height = videoEl.attr('height');
